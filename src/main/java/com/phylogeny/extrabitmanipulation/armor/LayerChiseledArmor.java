			...
			float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
	{
		...
		if (displayListsChestplate != null || displayListsSlotChestplate != null)
		{
			...
			if (displayListsChestplate != null)
			{
				...
				renderSleeve(displayListsChestplate[1], EnumHandSide.RIGHT, scale);
				renderSleeve(displayListsChestplate[2], EnumHandSide.LEFT, scale);
			}
			GlStateManager.popMatrix();
			if (displayListsSlotChestplate != null)
			{
				renderArmorPiece(body, displayListsSlotChestplate[0], scale, 8);
				renderSleeve(displayListsSlotChestplate[1], EnumHandSide.RIGHT, scale);
				renderSleeve(displayListsSlotChestplate[2], EnumHandSide.LEFT, scale);
			}
			GlStateManager.popMatrix();
		}
