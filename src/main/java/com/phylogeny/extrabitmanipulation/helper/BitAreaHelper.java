...
public class BitAreaHelper
{
	...
	public static boolean readBlockStates(ItemStack stack, EntityPlayer player, World world, BlockPos pos, Vec3 hit, Vec3i drawnStartPoint)
	{
	...
	public static ModelingBoxSet getModelingToolBoxSet(EntityPlayer player, ItemStack stack, int x, int y, int z,
			Vec3 hit, Vec3i drawnStartPointModelingTool, boolean addToBoxForRender)
	{
