...
public class ButtonsSetting
{
	...
	{
		return ItemStackHelper.getNBTOrNew(Minecraft.getMinecraft().thePlayer.getCurrentEquippedItem());
	}
	...
	public static class ModelAreaMode extends ButtonsSetting
	{
		...
		protected void setValue(EntityPlayer player, int value)
		{
			BitToolSettingsHelper.setModelAreaMode(player, player.getCurrentEquippedItem(), value, Configs.modelAreaMode);
		}
	...
	public static class ModelSnapMode extends ButtonsSetting
	{
		...
		protected void setValue(EntityPlayer player, int value)
		{
			BitToolSettingsHelper.setModelSnapMode(player, player.getCurrentEquippedItem(), value, Configs.modelSnapMode);
		}
	...
	public static class ModelGuiOpen extends ButtonsSetting
	{
		...
		protected void setValue(EntityPlayer player, int value)
		{
			BitToolSettingsHelper.setModelGuiOpen(player, player.getCurrentEquippedItem(), value == 0, Configs.modelGuiOpen);
		}
	...
	public static class SculptMode extends ButtonsSetting
	{
		...
		protected void setValue(EntityPlayer player, int value)
		{
			BitToolSettingsHelper.setSculptMode(player, player.getCurrentEquippedItem(), value, Configs.sculptMode);
		}
	...
	public static class Direction extends ButtonsSetting // TODO decompose to direction and rotation when triangular shapes are implemented
	{
		...
		protected void setValue(EntityPlayer player, int value)
		{
			BitToolSettingsHelper.setDirection(player, player.getCurrentEquippedItem(), value % 6, Configs.sculptDirection);
		}
...
//			return tool == null ? 0 : BitToolSettingsHelper.getShapeType(getHeldStackNBT(), tool.isCurved()); TODO
		...
		protected void setValue(EntityPlayer player, int value)
		{
			ItemSculptingTool tool = getSculptingTool();
			if (tool != null)
				BitToolSettingsHelper.setShapeType(player, player.getCurrentEquippedItem(), tool.isCurved(), value,
	...
	public static class BitGridTargeted extends ButtonsSetting
	{
		...
		protected void setValue(EntityPlayer player, int value)
		{
			BitToolSettingsHelper.setBitGridTargeted(player, player.getCurrentEquippedItem(), value == 1, Configs.sculptTargetBitGridVertexes);
		}
	...
	public static class HollowShape extends ButtonsSetting
	{
		...
		protected void setValue(EntityPlayer player, int value)
		{
			ItemSculptingTool tool = getSculptingTool();
			if (tool != null)
				BitToolSettingsHelper.setHollowShape(player, player.getCurrentEquippedItem(), tool.removeBits(),
	...
	public static class OpenEnds extends ButtonsSetting
	{
		...
		protected void setValue(EntityPlayer player, int value)
		{
			BitToolSettingsHelper.setEndsOpen(player, player.getCurrentEquippedItem(), value == 0, Configs.sculptOpenEnds);
		}
