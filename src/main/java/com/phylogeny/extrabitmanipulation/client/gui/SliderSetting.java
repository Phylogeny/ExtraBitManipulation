...
public class SliderSetting
{
	...
	public static class SemiDiameter extends SliderSetting
	{
		...
		protected void setValue(EntityPlayer player, int value)
		{
			BitToolSettingsHelper.setSemiDiameter(player, player.getCurrentEquippedItem(), value, Configs.sculptSemiDiameter);
		}
	...
	public static class WallThickness extends SliderSetting
	{
		...
		protected void setValue(EntityPlayer player, int value)
		{
			BitToolSettingsHelper.setWallThickness(player, player.getCurrentEquippedItem(), value, Configs.sculptWallThickness);
		}
