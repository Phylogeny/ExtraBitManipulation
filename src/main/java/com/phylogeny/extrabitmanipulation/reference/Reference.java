...
public class Reference
{
	...
	public static final String DEPENDENCIES = "required-after:" + ChiselsAndBitsReferences.MOD_ID + "@[12.11,);after:" +
												BaublesReferences.MOD_ID + ";after:" + GalacticraftReferences.MOD_ID + ";after:" + CustomNPCsReferences.MOD_ID;
